		...
		mono.android.IGCUserPeer
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AndroidHeartBeater.Renderers.HeartBeat, AndroidHeartBeater, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", HeartBeat.class, __md_methods);
	}


	public HeartBeat (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == HeartBeat.class)
			mono.android.TypeManager.Activate ("AndroidHeartBeater.Renderers.HeartBeat, AndroidHeartBeater, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public HeartBeat (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == HeartBeat.class)
			mono.android.TypeManager.Activate ("AndroidHeartBeater.Renderers.HeartBeat, AndroidHeartBeater, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public HeartBeat (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == HeartBeat.class)
	...
	public HeartBeat (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == HeartBeat.class)
